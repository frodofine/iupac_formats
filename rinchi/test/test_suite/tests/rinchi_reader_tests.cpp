...
void RInChIReaderTests::error_cases()
{
	check_rinchi_parsing_error(
		"01",
		"RInChI=1.00.1S/H3NO/c1-2/h2H,1H2/ hummus", "", "Unknown error validating InChI."
	);
	// RAuxInfo is not allowed as trailing data to the InChI.
	check_rinchi_parsing_error(
		"02",
		"RInChI=1.00.1S/<>H3NO/c1-2/h2H,1H2/d- RAuxInfo=1.00.1/<>/", "", "Unknown error validating InChI."
	);
	check_rinchi_parsing_error(
		"03",
		"RInChI=1.00.1S/<>H3NO/c1-2/h2H,1H2/d-\nRAuxInfo=1.00.1/<>/", "", "Unknown error validating InChI."
	);
